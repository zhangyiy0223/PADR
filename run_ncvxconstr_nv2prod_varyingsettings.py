'''
script to run experiments on nonconvex-constrained newsvendor problem with varying feature dimensions
'''
...
DATA_FOLDER_LIST = \
    [
        ...
        './data/nv2prod/lineardense/ydim2/xdim4',
        './data/nv2prod/lineardense/ydim2/xdim8',
        './data/nv2prod/lineardense/ydim2/xdim12',
        './data/nv2prod/lineardense/ydim2/xdim20',
        './data/nv2prod/lineardense/ydim2/xdim30',
        './data/nv2prod/lineardense/ydim2/xdim50',

        './data/nv2prod/linearsparse/ydim2/xdim4',
        './data/nv2prod/linearsparse/ydim2/xdim8',
        './data/nv2prod/linearsparse/ydim2/xdim12',
        './data/nv2prod/linearsparse/ydim2/xdim20',
        './data/nv2prod/linearsparse/ydim2/xdim30',
        './data/nv2prod/linearsparse/ydim2/xdim50',
    ]
...
EXP_NAME = 'ncvxconstr_varying_settings'
